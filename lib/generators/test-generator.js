...
class TestGenerator {
    constructor(_config, outputDir, projectManager, logger) {
    ...
    async generateModelUnitTests(model) {
        const testFile = this.projectManager.createSourceFile(node_path_1.default.join(this.outputDir, "tests", "unit", `${model.name}.test.ts`), undefined, { overwrite: true });
