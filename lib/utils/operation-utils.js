...
exports.isReadOnlyOperation = isReadOnlyOperation;
...
exports.getExposedName = getExposedName;
 ...
 */
function isReadOnlyOperation(opType) {
 ...
 */
function getExposedName(opType) {
    if (opType === "findUnique")
        return "findById";
    return opType;
}
/**
