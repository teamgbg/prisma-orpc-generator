...
exports.configSchema = zod_1.z.object({
    ...
    shieldPath: zod_1.z.string().optional(), // Path to custom shield file (absolute, relative to project root, relative to output dir, or module specifier)
    defaultReadRule: zod_1.z.enum(['allow', 'deny', 'auth']).default('allow'),
    defaultWriteRule: zod_1.z.enum(['auth', 'deny', 'allow']).default('auth'),
    denyErrorCode: zod_1.z.string().default('FORBIDDEN'),
